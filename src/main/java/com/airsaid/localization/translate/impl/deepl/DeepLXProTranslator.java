...
public class DeepLXProTranslator extends DeepLXTranslator {

    private static final String KEY = "DeepLXPro";
    private static final String HOST_URL = "https://127.0.0.1:1188/v1";
